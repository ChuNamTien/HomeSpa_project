...
export class CategoryUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.data.subscribe(({ category }) => {
            ...
            this.lastModifiedBy = this.category.lastModifiedBy != null ? this.category.lastModifiedBy.format(DATE_TIME_FORMAT) : null;
    ...
    save() {
        ...
        this.category.lastModifiedBy = this.lastModifiedBy != null ? moment(this.lastModifiedBy, DATE_TIME_FORMAT) : null;
