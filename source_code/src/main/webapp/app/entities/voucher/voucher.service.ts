...
export class VoucherService {
    ...
    private convertDateFromClient(voucher: IVoucher): IVoucher {
        const copy: IVoucher = Object.assign({}, voucher, {
            ...
            lastModifiedBy: voucher.lastModifiedBy != null && voucher.lastModifiedBy.isValid() ? voucher.lastModifiedBy.toJSON() : null,
            lastModifiedDate:
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((voucher: IVoucher) => {
            ...
            voucher.lastModifiedBy = voucher.lastModifiedBy != null ? moment(voucher.lastModifiedBy) : null;
