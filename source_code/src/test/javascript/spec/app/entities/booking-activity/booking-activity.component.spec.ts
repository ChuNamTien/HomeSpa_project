...
import { BookingActivityComponent } from 'app/entities/booking-activity/booking-activity.component';
...
describe('Component Tests', () => {
    describe('BookingActivity Management Component', () => {
        let comp: BookingActivityComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BookingActivityComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bookingActivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
