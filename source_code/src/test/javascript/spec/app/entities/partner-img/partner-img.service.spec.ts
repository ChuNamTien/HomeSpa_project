...
import { IPartnerImg, PartnerImg } from 'app/shared/model/partner-img.model';

describe('Service Tests', () => {
    describe('PartnerImg Service', () => {
        let injector: TestBed;
        let service: PartnerImgService;
        let httpMock: HttpTestingController;
        let elemDefault: IPartnerImg;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PartnerImg', async () => {
            ...
            it('should delete a PartnerImg', async () => {
