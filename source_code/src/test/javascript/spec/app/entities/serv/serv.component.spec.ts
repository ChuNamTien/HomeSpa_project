...
import { ServComponent } from 'app/entities/serv/serv.component';
import { ServService } from 'app/entities/serv/serv.service';
import { Serv } from 'app/shared/model/serv.model';

describe('Component Tests', () => {
    describe('Serv Management Component', () => {
        let comp: ServComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ServComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.servs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
